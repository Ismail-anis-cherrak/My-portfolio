...
const Services = () => {
  const [services] = useState([
    ...
    },
    {
      ...
      name: 'Scripting & Problem Solving',
      description: 'Automating tasks and solving operational problems with scripts and lightweight tools.',
      details: 'I develop scripts and small utilities (Python, Bash, PowerShell) to automate repetitive tasks, parse and analyze logs, perform system maintenance, and streamline workflows. I also approach problems with algorithmic thinking to debug issues efficiently, design reliable solutions, and reduce manual overhead.',
    },
    // {
