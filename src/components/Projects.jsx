...
// import cybersec from '../../public/images/cybersec.json'
// import pentesting from '../../public/images/pentesting.json'
// import code from '../../public/images/code.json'
// import network from '../../public/images/network.json'
// import wifi from '../../public/images/wifi.json'
// import programming from '../../public/images/programming.json'
...
//       <h1 className='text-7xl font-bold mb-8 text-center'>My projects</h1>
    ...
    <div className="text-white w-full py-16" id="projects">
        ...
        {projects.map((category, index) => (
          <div key={index}>
            <h1 className="text-3xl font-bold mb-8 text-center flex items-center justify-center space-x-2">
              <Lottie options={lottieOptions(category.category === 'Development' ? Development : (category.category === 'Networking' ? Networking : cybersecurity))} height={80} width={80} style={{ margin: '0', padding: '0' }}  />
              <span className='mx-8 px-8'>{category.category}</span>
             <Lottie options={lottieOptions(category.category === 'Development' ? Development : (category.category === 'Networking' ? Networking : cybersecurity))} height={80} width={80} style={{ margin: '0', padding: '0' }} />
            </h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {category.items.map((project, index) => (
      ...
      <div className="max-w-8xl mx-auto px-4 mt-16 mb-8">
        <h1 className="text-3xl font-bold mb-8 text-center flex items-center justify-center space-x-2">
          ...
          <span className='px-8'>Testimonies</span>
          <Lottie options={lottieOptions(testimony)} height={60} width={60} style={{ margin: '0', padding: '0' }}  />
        </h1>
        <div className="flex flex-wrap justify-center -mx-4">
          {testimonies.map((testimony, index) => (
